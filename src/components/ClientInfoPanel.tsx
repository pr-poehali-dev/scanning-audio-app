...
const ClientInfoPanel = ({ 
  ...
  return (
    <>
      <div className="hidden lg:flex fixed left-[92px] top-16 h-[calc(100vh-4rem)] w-[250px] bg-white border-r flex-col">
        ...
        <div className="flex-1 overflow-y-auto p-5 space-y-5">
          ...
          <div className="bg-gray-100 rounded-3xl p-8">
            ...
            <div className="text-[140px] font-black text-gray-900 text-center leading-none">
              {client.cellNumber}
            </div>
          </div>
          ...
          <div className="text-center">
            ...
            <button
              ...
              className="w-full flex items-center justify-center gap-3 p-3 border-2 border-dashed border-gray-300 rounded-xl hover:border-purple-400 transition-colors"
            >
              ...
              <div className="text-3xl font-bold text-gray-900">{totalPackages || '0'}</div>
            </button>
          </div>
          ...
          <div className="text-center">
            ...
            <button className="text-xs text-purple-600 mt-1 flex items-center justify-center gap-1">
