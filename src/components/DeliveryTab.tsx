              ...
              {mockProducts.map((product) => (
                <div key={product.id} className="relative">
                  <div className="absolute top-2 left-2 z-10 flex items-center gap-1">
                    ...
                    <div className="bg-purple-600 text-white text-xs px-2 py-1 rounded font-bold shadow-md">
                      Ячейка {cellNumber}
                    </div>
                  </div>
                  <div className="absolute top-2 right-2 z-10 flex flex-col gap-1 items-end">
                    ...
                    <div className="bg-gray-100 text-gray-700 text-xs px-2 py-1 rounded font-medium shadow-sm">
                      Товаров: 2 из 2
                    </div>
                  </div>
