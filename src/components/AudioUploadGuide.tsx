            ...
            <div className="text-sm space-y-2">
              <div className="bg-purple-50 rounded p-2">
                ...
                <ul className="ml-4 mt-1 space-y-0.5 text-xs">
                  <li>• Ячейки: <code className="bg-white px-1 rounded">cell_v1_1.mp3 ... cell_v1_482.mp3</code></li>
                  <li>• Фразы: <code className="bg-white px-1 rounded">goods.mp3, payment_on_delivery.mp3, please_check_good_under_camera.mp3, thanks_for_order_rate_pickpoint.mp3, success_sound.mp3</code></li>
                </ul>
              </div>
              <div className="bg-blue-50 rounded p-2">
                <strong className="text-blue-700">📦 Вариант озвучки 2:</strong>
                <ul className="ml-4 mt-1 space-y-0.5 text-xs">
                  <li>• Ячейки: <code className="bg-white px-1 rounded">cell_v2_1.mp3 ... cell_v2_482.mp3</code></li>
                  <li>• Фразы: <code className="bg-white px-1 rounded">checkWBWallet.mp3, scanAfterQrClient.mp3, askRatePickPoint.mp3</code></li>
                </ul>
              </div>
